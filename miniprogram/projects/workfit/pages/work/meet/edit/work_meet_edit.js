...
Page({
	...
	data: {
		isLoad: false,
		isAdmin: false, // 教师端需要设置为false，但要允许编辑学生填写项目
	},
	...
	bindFormEditSubmit: async function () {
		...
		if (data.formJoinForms.length <= 0) return pageHelper.showModal('请至少设置一项「学生填写资料」');
