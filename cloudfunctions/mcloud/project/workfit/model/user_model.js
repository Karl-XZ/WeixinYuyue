...
UserModel.DB_STRUCTURE = {
	...
	USER_SUBSCRIBE: 'object|true|default={}|comment=一次性订阅状态',
	USER_STATUS: 'int|true|default=1|comment=状态 0=待审核,1=正常,8=审核未过,9=禁用',
	USER_CHECK_REASON: 'string|false|comment=审核未过原因',

	USER_NAME: 'string|false|comment=学生名称',
	USER_MOBILE: 'string|false|comment=联系电话',
	USER_PASSWORD: 'string|false|comment=学生密码',
