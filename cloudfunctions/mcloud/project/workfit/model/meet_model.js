...
MeetModel.DB_STRUCTURE = {
	...
	MEET_EMAIL: 'string|false|comment=教师邮箱',
	MEET_EMAIL_VERIFIED: 'int|true|default=0|comment=邮箱是否已验证 0否1是',
	MEET_EMAIL_VERIFY_TIME: 'int|true|default=0|comment=邮箱验证时间',
